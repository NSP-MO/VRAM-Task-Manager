...
| :--- | :--- | :--- |
| **Setup Installer** | `VramTaskManager_Setup_v0.1.2_x64.exe` | Inno Setup wizard with desktop and Start Menu shortcuts, uninstaller, and automated .NET runtime verification. |
| **Portable Archive** | `VramTaskManager_Portable_v0.1.2_x64.zip` | Standalone archive containing all runtime binaries. Extract and run `VramTaskManager.exe` directly. |
...
4. **Create Portable ZIP Archive**:
   ```powershell
   Compress-Archive -Path ./publish/* -DestinationPath ./installer/output/VramTaskManager_Portable_v0.1.2_x64.zip -Force
   ```
